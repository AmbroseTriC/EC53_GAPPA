...
\title{Progressivity of Canada's Federal Fuel Charge (GGPPA Part I) and the Canada Carbon Rebate (CCR), 2019--2025\\
...
\input{table_selected_results.tex}
\endgroup
...
\setlength{\LTleft}{0pt}
\setlength{\LTright}{0pt}
\input{table_finance_crosswalk.tex}
\endgroup
...
\setlength{\LTleft}{0pt}
\setlength{\LTright}{0pt}
\input{table_kakwani.tex}
\endgroup

Figure~\ref{fig:kakwani_heatmap} provides a compact visual summary of the same Kakwani output across provinces, years, and measures. Positive values indicate progressivity relative to total expenditure, while negative values indicate regressivity.

\begin{figure}[htbp]\centering
  \includegraphics[width=\textwidth]{../Figures/kakwani_heatmap_facets_combined.pdf}
  \caption{Kakwani index heatmap by province, year, and selected incidence measure.}
  \label{fig:kakwani_heatmap}
\end{figure}
