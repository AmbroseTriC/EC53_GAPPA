#!/usr/bin/env python3
"""
compute_ggppa_progressivity_v3.py
...
Outputs
-------
1) ggppa_progressivity_results_v3.csv
...
def main() -> None:
    ...
    df["ng_GJ"] = df.apply(lambda r: r["ng_exp"] * GJ_PER_DOLLAR.get(r["Province"], float("nan")), axis=1)
    ...
    df[out_cols].to_csv("ggppa_progressivity_results_v3.csv", index=False)
    ...
    pd.DataFrame(kak_rows).to_csv("ggppa_kakwani_indices_v3.csv", index=False)
    ...
    diag.to_csv("ggppa_finance_crosswalk_3.csv", index=False)
