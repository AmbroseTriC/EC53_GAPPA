#!/usr/bin/env python3
"""
compute_ggppa_progressivity_v2.py
...
def main() -> None:
    ...
    df[out_cols].to_csv("ggppa_progressivity_results_v2.csv", index=False)
    ...
    pd.DataFrame(kak_rows).to_csv("ggppa_kakwani_indices_v2.csv", index=False)
    ...
    diag.to_csv("ggppa_finance_crosswalk_v2.csv", index=False)
